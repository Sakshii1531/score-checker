...
import chooseRole from "../assets/chooseRole.png";
import interviewQuestion from "../assets/interviewQuestion.png";
import feedbackpng from "../assets/feedbackpng.png";
...
const steps = [
  ...
  {
    icon: <TrendingUp className="w-12 h-12 text-purple-400 drop-shadow-[0_0_8px_rgba(128,0,255,0.4)]" />,
    title: "Improve with Insights",
    description:
      "Track progress with analytics like filler words, pacing, and personalized suggestions to improve.",
    image: improve,
  },
];
